...
ax.set_title("Decision Tree - Wine Dataset (using gini)", fontsize=20)
...
# Customize the plot aesthetics
ax.set_title("Decision Tree - Wine Dataset for max depth=3 (using gini)", fontsize=20)
ax.set_xlabel("Features", fontsize=14)
ax.set_ylabel("Wine Class", fontsize=14)
# Adjust the arrow properties
for arrow in ax.get_xticklines():
...
# Display the plot
plt.show()
classifier = DecisionTreeClassifier(criterion = 'gini', random_state = 0,max_depth = 2)
...
# Customize the plot aesthetics
ax.set_title("Decision Tree - Wine Dataset for max depth=2 (using gini)", fontsize=20)
ax.set_xlabel("Features", fontsize=14)
ax.set_ylabel("Wine Class", fontsize=14)
# Adjust the arrow properties
for arrow in ax.get_xticklines():
